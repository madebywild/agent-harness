...
export const COMMAND_DEFINITIONS: readonly CommandDefinition[] = [
  {
    ...
    options: [
      ...
      {
        name: "uHaul",
        description: "import legacy provider assets into canonical .harness sources, then apply",
        takesValue: false,
        defaultValue: false,
      },
      {
        name: "uHaulPrecedence",
        description: `select primary provider precedence for u-haul (${providerIdSchema.options.join(", ")})`,
        takesValue: true,
      },
    ],
      ...
      handleInit(
        {
          ...
          uHaul: readBooleanOption(input, "uHaul"),
          uHaulPrecedence: readStringOption(input, "uHaulPrecedence"),
        },
        context,
      ),
  },
