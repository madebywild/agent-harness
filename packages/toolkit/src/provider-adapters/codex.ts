...
import { mergeMcpServers, normalizeMcpServersUrlField } from "./mcp.js";
  ...
  mcpRenderer: {
    ...
    render(servers) {
      return withSingleTrailingNewline(
        TOML.stringify({
          mcp_servers: normalizeMcpServersUrlField(servers) as unknown as TOML.AnyJson,
        }),
      );
    },
  },
          ...
          enabledSubagents
            ...
            .map((subagent) => {
              ...
              if (options.mcpServers) {
                agentState.mcp_servers = normalizeMcpServersUrlField(options.mcpServers);
              }
