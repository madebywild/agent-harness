...
- Enforced source paths by entity type (`PROMPT_SECTION_SOURCE_INVALID`, `SKILL_SOURCE_INVALID`, `MCP_SOURCE_INVALID`, `SUBAGENT_SOURCE_INVALID`, `HOOK_SOURCE_INVALID`).
